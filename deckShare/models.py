...
class Profile(models.Model):
	...
	awaitingResponse = models.ManyToManyField('self', blank=True, symmetrical=False, related_name="friendAwaiting")
	offeredFriendship = models.ManyToManyField('self', blank=True, symmetrical=False, related_name="friendOffering")
