...
def matches(request):
	...
	return render(request, "deckShare/matches.html", {"matches": Match.Match.objects.filter(Q(deck1__owner=request.user.profile) | Q(deck2__owner=request.user.profile))}
